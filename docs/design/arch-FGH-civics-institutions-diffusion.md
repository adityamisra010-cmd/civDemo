...
| **V2** | **Conscription** buys Safety with Sustenance (F17 — RATIFIED as the path-6 example) | Exit, Voice | 1 · 3 · 7 — **all M5** | conscription removes producers → output falls → Sustenance falls → the conscribable base shrinks. Self-limiting at exactly the rate it is pushed |
