...
(`docs/m4-pre-spec-dependencies.md:143-160`). **RATIFIED (as a recorded finding).**
...
| **G8(c) / CR-016 option 3 — the per-year food-balance sub-step** | *"option 3 … remains queued as **M5-scale work**"* | `docs/adr/cr-016-armed-disaster-fallout.md:305-310` — **RATIFIED as queued**; CR-016 itself is **OPEN** |
...
| **Characters/notables residual layer · Finance · Media/nationalism** | Spine `:92-94` | **RATIFIED as late/era-expansion** |
