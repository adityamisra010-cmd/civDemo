...
public static class CanonicalSchema
{
    ...
    /// v22 (M4, D-042): Polities and Capitals tables appended after Notables.
    ...
    /// Empire identity. Schema only — no system writes either table yet.</summary>
    ...
    private const int PolityRowWidth = 4 + 4;                       // Id, Source (v22)
    private const int CapitalRowWidth = 4 + 4;                      // Polity, Place (v22)
    ...
    public static void Write(WorldState world, BinaryWriter writer)
    {
        ...
        // 36. Polities (v22, M4, D-042: the Empire roster and its command source)
        ...
        // 37. Capitals (v22, M4, D-042: capital as a RELATION, absence = none)
