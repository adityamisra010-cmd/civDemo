...
**Current milestone: M2 COMPLETE. Next: M3 — do NOT implement until `docs/m3-spec.md` exists on main and its packets are cut.** (This line changes only at a milestone exit gate.)
