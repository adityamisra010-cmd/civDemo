...
/// covered by THIS file, the driven soak, AND two goldens — and a green golden
/// IS now evidence about the solver, though not a substitute for the
/// per-term sensitivity tests below, which remain the ones with teeth.
/// </summary>
